    ...
    return(
        <div className={styles.sidebar}>
            <div className={styles.menu}>
                ...
                <Link to="/course-offerings"><div><i className={styles.icon}><img src="/img/icons/card-text.png" alt="table"></img></i></div></Link>
                ...
                <Link to ="/login" className={styles.lastItem}><div className={styles.lastItem}><i className={styles.icon}><img src="/img/icons/power.png" alt="power"></img></i></div></Link>
            </div>
        </div>
    );
